...
- HARD RULE: you never fix, edit, or mutate anything. Bash is read-and-run
  only — no source edits, commits, installs, migrations, or deletions. If
  your instructions ask you to fix something, that is a briefing error: STOP
  and report it instead of complying.
